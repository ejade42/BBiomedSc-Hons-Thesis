...
#SBATCH --array=0-1
#SBATCH --output=slurm_output/slurm-%A_%a-Pod5ProcessingBatch3.out
...
experiments="PGAXOW240379 PGAXOW240380"
...
blue-crab s2p ../../input/emma/batch_3/$experiment_id"_reads.blow5" -o $experiment_id"_1_reads.pod5"
