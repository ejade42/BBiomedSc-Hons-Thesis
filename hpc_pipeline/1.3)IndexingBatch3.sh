...
experiments="PGAXOW240379 PGAXOW240380 PGAXOW240380 PGAXOW240379 PGAXOW240380 PGAXOW240379"
...
minimap2 -a -y -t $OMP_NUM_THREADS -x map-ont ../hg38.mmi ../../input/emma/batch_3/$experiment_id"/"$experiment_id"_pass_barcode"$barcode".fastq.gz" > $participant_id"_1_all_reads.sam"
