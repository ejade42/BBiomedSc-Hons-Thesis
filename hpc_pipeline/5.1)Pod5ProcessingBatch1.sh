...
#SBATCH --array=0-2
#SBATCH --output=slurm_output/slurm-%A_%a-Pod5ProcessingBatch1.out
...
experiments="PGAXHC230412 PGAXHC240012 PGAXHX240013"
...
blue-crab s2p ../../input/emma/batch_1/$experiment_id"_reads.blow5" -o $experiment_id"_1_reads.pod5"
